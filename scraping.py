...
for year in tqdm(range(2008, 2020)):
            ...
            for k in tqdm(range(1, 11)):
                for l in range(1, 13):
                    ...
                    if soup.find_all('div', attrs={'class', 'Result_Guide'})!=[]:
                        ...
                        CommonHcount= soup.find_all('dd', attrs={'class', 'Race_Data'})[0].contents[3].split(')')[1].split()[0]
                        CommonWeather= soup.find_all('dd', attrs={'class', 'Race_Data'})[0].contents[3].split(')')[1].split()[1]
                        ...
                        for m in range(len(soup.find_all('div', attrs='Rank'))):
                            ...
                            try:
                                ...
                                dst['j_weight'] = detailR[2].strip().replace('(', '').replace(')', '') #多分jackieの体重
    ...
    df.to_csv('keiba'+str(year)+'.csv', encoding='UTF-8')
